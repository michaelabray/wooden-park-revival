...
export const UNITS: UnitType[] = [
  ...
  },
  {
    ...
    baseYield: 1.80,
    icon: 'Trophy',
    image: '/wooden-park-revival/assets/units/varsity-bobkat.webp',
  },
  {
    id: 'ai-whiz',
    name: 'AI-Whiz',
    ...
    baseYield: 10.00,
    icon: 'Cpu',
    image: '/wooden-park-revival/assets/units/ai-whiz.webp',
  },
  {
    id: 'rogue-graduate',
    name: 'Rogue Graduate',
    ...
    baseYield: 60.00,
    icon: 'GraduationCap',
    image: '/wooden-park-revival/assets/units/rogue-graduate.webp',
  },
];
...
export const BLUEPRINTS: BlueprintPiece[] = [
  {
    ...
    icon: 'Footprints',
    image: '/wooden-park-revival/assets/blueprints/steps.webp',
  },
  {
    id: 'slide',
    ...
    icon: 'TrendingDown',
    image: '/wooden-park-revival/assets/blueprints/slide.webp',
  },
  {
    id: 'swing',
    name: 'The Swings',
    ...
    icon: 'Wind',
    image: '/wooden-park-revival/assets/blueprints/swings.webp',
  },
  {
    id: 'walls',
    name: 'The Walls',
    ...
    icon: 'Boxes',
    image: '/wooden-park-revival/assets/blueprints/wall.webp',
  },
  {
    id: 'statue',
    ...
    icon: 'Crown',
    image: '/wooden-park-revival/assets/blueprints/founder.webp',
  },
];
